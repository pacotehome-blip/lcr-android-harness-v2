...
public class LcpLink {
    ...
    private Frame readFrameUntil(long deadlineMs) throws IOException {
        // ✅ RETIRÉ (28 août 2026, demande Paul — "je ne veux plus") —
        // diagnostic ajouté plus tôt aujourd'hui pour compter les
        // fragments BT par trame. Réponse déjà obtenue et documentée
        // (2-4 appels io.read() par trame, confirmé sur logcat réel) —
        // plus besoin de le mesurer en continu.
