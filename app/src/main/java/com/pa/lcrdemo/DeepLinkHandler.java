...
import java.io.InputStream;package com.pa.lcrdemo;
        ...
        try {
            ...
            try {
                ...
                if (result != null) {
                    ...
                    // Couvre LCR-II (Field #44/#45 directs) et LC3 (calcul delta).
                    // Le tick contient toujours les dernières valeurs lues avec succès.
